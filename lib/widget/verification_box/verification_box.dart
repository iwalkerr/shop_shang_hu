...
import 'package:shop_shang_hu/widget/verification_box/verification_box_item.dart';

///
/// 验证码输入框
///
///
GlobalKey<_VerificationBox> childKey = GlobalKey();
    ...
    setState(() {
      ...
      for (int i = 0; i < widget.count; i++) {
        if (i < _controller.text.length) {
          _contentList[i] = _controller.text.substring(i, i + 1);
        } else {
          _contentList[i] = '';
        }
      }
